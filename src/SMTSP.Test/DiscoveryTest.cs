...
public class DiscoveryTest
{
    ...
    public void Setup()
    {
        ...
        _secondDevice = new DeviceInfo("EE27A6ED-6F30-4299-A35F-AC3B7139F733", "TestDevice 2", 42013, DeviceTypes.Phone, "192.168.1.43", new[] { "InterShare" });
        _secondDiscovery = new Discovery.Discovery(_secondDevice);
    }

    private void RunAdvertiser()
    {
        _firstDevice = new DeviceInfo("05DD541B-B351-4EE3-9BA5-1F9663E0FC4B", "TestDevice 1", 42003, DeviceTypes.Computer, "192.168.1.42", new[] { "InterShare" });
    ...
    {
        _secondDiscovery.StartDiscovering();
